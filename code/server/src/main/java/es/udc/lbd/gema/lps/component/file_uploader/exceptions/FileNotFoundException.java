...
public class FileNotFoundException extends AppException {
  ...
  public FileNotFoundException(String errorCode, HttpStatus status) {
    super(errorCode, status);
  }

  public FileNotFoundException(String errorCode, String parameter, HttpStatus status) {
    super(errorCode, parameter, status);
  }

  public FileNotFoundException(
      String errorCode, Map<String, String> parameters, HttpStatus status) {
