/*% if (feature.T_GIS) { %*/
package es.udc.lbd.gema.lps.model.util.jackson;
...
public class CustomGeometryDeserializer extends JsonDeserializer<Geometry> {
  ...
  public static int SRID = /*%= data.basicData.SRID || 4326  %*/;
  ...
  private Geometry parseGeometry(JsonNode root) {
    ...
    if (typeName.equals("Point")) {
      ...
      return geometryFactory.createMultiPointFromCoords(parseLineString(coordinates));
